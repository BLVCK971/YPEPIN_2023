...
export default function PricingPureCSS() {
  return (
    <div className="UIBox  grid grid-rows-3  border-neutral-800 w-auto rounded-xl border  m-5 max-w-sm  overflow-hidden shadow-lg">
            <Link href={"/Web/PricingPureCSS/index.html"} className="row-span-3">
        <Image
          unoptimized
          src="/pricing.png"
          width={800}
      ...
      <h1 className="text-xl font-bold mb-2">PricingPureCSS</h1>
      <div className="text-base font-semibold">
        Carte de prix avec effet 3D
      </div>
      </div>

      <Link href={"/Web/PricingPureCSS/index.html"} className="flex justify-center">
